 ...
 * https://github.com/woxingxiao/DashboardView/blob/master/app/src/main/java/com/xw/sample/dashboardviewdemo/DashboardView3.java
 */
...
public class DashboardView extends View {
    ...
    private void init() {
        ...
        mBgColors = new int[]{
                ...
                ContextCompat.getColor(getContext(), R.color.color_purple),
                ContextCompat.getColor(getContext(), R.color.color_dark_red),
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawColor(calculateBGColorWithValue());
    ...
    private String calculateCreditDescription() {
        ...
        } else if (mCreditValue > 50 && mCreditValue <= 100) {
            return getResources().getString(R.string.level_2);
        } else if (mCreditValue > 100 && mCreditValue <= 150) {
            return getResources().getString(R.string.level_3);
        } else if (mCreditValue > 150 && mCreditValue <= 200) {
            return getResources().getString(R.string.level_4);
        } else if (mCenterX > 200 && mCreditValue <= 300) {
            return getResources().getString(R.string.level_5);
        } else {
            return getResources().getString(R.string.level_6);
        }
     ...
     * 信用分对应信用描述
     */
    private int calculateBGColorWithValue() {
        if (mCreditValue <= 50) {
            return mBgColors[0];
        } else if (mCreditValue > 50 && mCreditValue <= 100) {
            return mBgColors[1];
